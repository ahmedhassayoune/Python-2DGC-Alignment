...
def swpa_input(chromato_dir, swpa_input_path, dict_chromatos, peak_detection_thr=5):
    ...
    for i, file in enumerate(files):
        ...
        projected_coordinates = projection.matrix_to_chromato(coordinates, time_rn, 1.25, chromato.shape)
        ...
        for (rt1_idx, rt2_idx), (rt1, rt2) in zip(coordinates, projected_coordinates):
            ...
            spectral_data = np.pad(spectral_data, (frange_min - range_min, range_max - frange_max), mode='constant', constant_values=0)
